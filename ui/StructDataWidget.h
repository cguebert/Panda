...
class BaseListDataDialog : public QDialog
{
	Q_OBJECT
public:
	BaseListDataDialog(QWidget* parent)
		: QDialog(parent)
	{}
...
template<class T, class Container = data_widget_container< panda::vector_data_trait<T>::row_type > >
class ListDataDialog : public BaseListDataDialog
{
protected:
	typedef T value_type;
	typedef panda::Data<T> data_type;
...
public:
	ListDataDialog(QWidget* parent, const data_type& d, bool readOnly)
		: BaseListDataDialog(parent)
		, readOnly(readOnly)
		, scrollArea(nullptr)
		, formLayout(nullptr)
		, resizeWidget(nullptr)
