...
class RenderSpriteGeometryShader : public Renderer
{
public:
		...
		, m_shader(initData("shader", "Shaders used during the rendering"))
	{
		...
		m_shader.setWidgetData("Vertex;Geometry;Fragment");
		auto shaderAcc = m_shader.getAccessor();
		shaderAcc->setSourceFromFile(Shader::ShaderType::Vertex, "shaders/spriteGS.v.glsl");
		shaderAcc->setSourceFromFile(Shader::ShaderType::Geometry, "shaders/spriteGS.g.glsl");
		shaderAcc->setSourceFromFile(Shader::ShaderType::Fragment, "shaders/spriteGS.f.glsl");
	}
