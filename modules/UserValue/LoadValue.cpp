...
int LoadValue_FloatClass = RegisterObject< LoadValue<float> >("File/Real/Load real").setDescription("Load a value from a file");
int LoadValue_FloatVectorClass = RegisterObject< LoadValue<types::FloatVector> >("File/Reals vector/Load reals vector").setDescription("Load a value from a file");
...
int LoadValue_IntVectorClass = RegisterObject< LoadValue<types::IntVector> >("File/Integers vector/Load integers vector").setDescription("Load a value from a file");
...
int LoadValue_VectorFloatClass = RegisterObject< LoadValue< std::vector<float> > >("File/Real/Load reals list").setDescription("Load a value from a file");
int LoadValue_VectorFloatVectorClass = RegisterObject< LoadValue< std::vector<types::FloatVector> > >("File/Reals vector/Load reals vector list").setDescription("Load a value from a file");
...
int LoadValue_VectorIntVectorClass = RegisterObject< LoadValue< std::vector<types::IntVector> > >("File/Integers vector/Load integers vector list").setDescription("Load a value from a file");
...
int LoadValue_AnimationFloatClass = RegisterObject< LoadValue< types::Animation<float> > >("File/Real/Load reals animation").setDescription("Load a value from a file");
