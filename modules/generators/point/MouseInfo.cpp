...
int GeneratorPoint_MouseInfoClass = RegisterObject("Generator/Point/Mouse").setClass<GeneratorPoint_MouseInfo>().setName("Mouse").setDescription("Gives information about the mouse in the render view");
