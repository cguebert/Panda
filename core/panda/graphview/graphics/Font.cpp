#include <panda/graphview/graphics/Font.h>
					  ...
					  float wrap_width, bool cpu_fine_clip) const
{
	...
	DrawList::DrawVert* vtx_write = draw_list->vtxWritePtr();
	DrawList::DrawIdx* idx_write = draw_list->idxWritePtr();
	DrawList::DrawIdx vtx_current_idx = draw_list->vtxCurrentIdx();
