...
public:
	...
	int delayRun(double seconds, VoidFunc func); // Returns an id that can be used to cancels the execution of the function. If delay is negative, run immediately and returns -1.
